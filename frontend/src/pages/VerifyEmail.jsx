            ...
            <div className="w-[25rem] min-w-[20rem] max-w-[25rem] my-8 mx-auto">
              <div className="">
                ...
                <div className="my-4">
                  ...
                  <button
                    className='bg-green-500 w-full flex items-center gap-2 text-black font-light hover:bg-[#22c55eb0] transform active:scale-95 transition-all duration-200'
                    onClick={() => dispatch(sendOtp(fromdata.email, navigate))}>
